	...
	public class ProductController {
		...
		public ResponseEntity<CompletableFuture<PagedQueryResult<ProductProjection>>> getProductByCategory(@PathVariable("categoryid") String categoryid)
				throws ProductException {
			...
			try {
				productswithcategory = ProductService.findProductsWithCategory(client, categoryid);
